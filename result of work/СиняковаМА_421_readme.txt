Дипломная работа студентки 421 группы Синяковой Марины Алексеевны.

Для работы программы необходимо установить на свой компьютер средство lp_solve в диреторию "../lp_solver/" от основного проекта. Данное средство приложено во вложении в архиве lp_solve.tar.gz, при возникновении проблем с установкой его можно скачать по ссылке https://sourceforge.net/projects/lpsolve/files/lpsolve/5.5.2.5/lp_solve_5.5.2.5_exe_ux64.tar.gz/download . Обратите внимение, что бинарный файл lp_solve должел лежать в указанной директории.
...
Более подробно ознакомится с этапами развития проекта можно по ссылке https://github.com/msinyakova/Diploma
